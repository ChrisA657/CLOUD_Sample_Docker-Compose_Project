...
CREATE TABLE farm(
    farm_id INTEGER NOT NULL AUTO_INCREMENT,  PRIMARY KEY(farm_id),
    farm_name VARCHAR(50) NOT NULL,
    farmer_id INTEGER NOT NULL, FOREIGN KEY (farmer_id) REFERENCES product(farmer_id),
    farm_picture VARCHAR(50) NOT NULL,
    farm_description VARCHAR(50),
    farm_rating VARCHAR(50) NOT NULL,
    farm_established VARCHAR(50) NOT NULL
)