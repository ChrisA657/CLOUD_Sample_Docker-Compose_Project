...
//this route is for User Story 2.2 where "As a farmer, I want to be able to add my products"
    try{
        const body = req.body;
        const result = await Product.createEvent(body.event, body.product_name, body.product_price, body.product_stock. body.product_description, body.farmer_id, body.farm_name);
